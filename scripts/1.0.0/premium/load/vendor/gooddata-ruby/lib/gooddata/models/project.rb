...
module GoodData
  class Project < Rest::Resource
    ...
    class << self
      ...
      def transfer_etl(client, from_project, to_project)
        ...
        res.group_by { |x| [x[1], x[2]]}
           ...
           .peach(&:delete)  
        transfer_schedules(client, from_project, to_project)
      end

      def transfer_schedules(client, from_project, to_project)
    ...
    def clone_with_etl(project, options)
      ...
      GoodData::Project.transfer_etl(client, project, a_clone)
      a_clone
    end
